    ...
    <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 sm:p-8 relative overflow-hidden shadow-xl">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-800">
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="text-xl font-black text-white">Google İşletme Puanı</h3>
              <span className="flex items-center gap-1 bg-emerald-500/10 text-emerald-400 text-xs px-2.5 py-0.5 rounded-full font-bold border border-emerald-500/20">
                <CheckCircle2 className="w-3 h-3" /> Doğrulanmış Profil
              </span>
            </div>
            <div className="flex items-center gap-2 mt-1">
              ...
              <span className="text-xs text-slate-400 font-medium">(148+ Müşteri İncelemesi)</span>
            </div>
          </div>
        </div>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 hover:text-white text-xs font-bold transition-all border border-slate-700 shadow-sm"
        >
        ...
        {reviews.map((rev) => (
          ...
          >
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex flex-col items-end">
                  ...
                  <span className="text-[10px] text-slate-500 mt-0.5">{rev.date}</span>
                </div>
              </div>
            ...
            <div className="mt-4 pt-3 border-t border-slate-800/60 flex items-center justify-between text-[11px] text-slate-400">
              ...
              <span className="text-slate-500">Doğrulanmış İş Makinası Sahibi</span>
            </div>
          </div>
        ))}
      </div>
