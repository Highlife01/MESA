  ...
  <footer className="mesa-footer">
    <div className="site-chrome-container">
      ...
      <div className="site-footer-main">
        ...
        <div className="site-footer-contact"><h3>BİZE ULAŞIN</h3><a className="site-footer-phone" href="tel:05335293674"><Phone size={16} aria-hidden="true" />0533 529 36 74</a><a href="mailto:info@mesaismakinalari.com.tr"><Mail size={15} aria-hidden="true" />info@mesaismakinalari.com.tr</a><p><MapPin size={17} aria-hidden="true" /><span>Yeşiloba Mah. 46167. Sokak No: 19/A<br />01170 Seyhan / Adana</span></p><span className="site-footer-available"><i aria-hidden="true" />7/24 mobil servis desteği</span></div>
      </div>
